...
parameters['name'] = "BLSTM_German_50_epochs" # Model name
...
def get_lstm_features(self, sentence, chars2, chars2_length, d):
    # MODIFIED: no char level embeddings for BLSTM
    ...
    # MODIFIED: don't *2 for unidirectional lstm
...
class BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim,
        ...
        # MODIFIED: unidirectional for LSTM variant
